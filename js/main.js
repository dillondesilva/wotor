...
function preload () {
  ...
  game.load.spritesheet('ship', 'assets/spaceship.png', 100, 70, 2);
  game.load.image('bullet', 'assets/playerbullet.png');
  game.load.image('bullet2', 'assets/player2bullet.png');
  game.load.spritesheet('ship2', 'assets/player2ship.PNG', 100, 70, 2);
  game.load.spritesheet('enemy', 'assets/enemyship.png', 100, 70, 2);
...
function create () {
  ...
  player1.animations.play('emissionsP1', 35, true);

  var emissionsP2 = player2.animations.add('emissionsP2');
  player2.animations.play('emissionsP2', 35, true);
...
function createEnemy () {
  ...
  enemy.animations.play('emissionsEnemy', 35, true);
